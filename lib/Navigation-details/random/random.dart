...
class RandomHouse extends StatefulWidget {
  const RandomHouse({super.key});

  @override
  State<RandomHouse> createState() => _RandomHouseState();
}

class _RandomHouseState extends State<RandomHouse> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Text('Deals',maxLines: 1,overflow:TextOverflow.ellipsis,style: TextStyle(color: Colors.white)),
      ),
      body:Padding(
