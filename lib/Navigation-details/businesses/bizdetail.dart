...
class BuzinessDetail extends StatefulWidget {
  ...
  const BuzinessDetail({ required this.ID, required this.UID, required this.logo, required this.shopim, required this.biznem, required this.phon1, required this.maill, required this.tax, required this.tin, required this.ad, required this.lon, required this.lat, required this.tim, required this.stat, required this.ser, required this.open, required this.ratin, required this.totRat, required this.toppik, required this.cret, required this.paid, required this.online, required this.cod, required this.end, required this.renu, required this.blo,});

  @override
  State<BuzinessDetail> createState() => _BuzinessDetailState();
}

class _BuzinessDetailState extends State<BuzinessDetail> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<BusinessProvider>(context,listen: false).getAllBizDetail(widget.biznem);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Text(widget.biznem,maxLines: 1,overflow:TextOverflow.ellipsis,style: TextStyle(color: Colors.white)),
      ),
      body:Padding(
