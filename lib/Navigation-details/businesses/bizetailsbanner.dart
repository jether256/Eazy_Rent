...
class BuzDetailsBanner extends StatefulWidget {
  ...
  const BuzDetailsBanner({required this.id, required this.User_id, required this.biz, required this.tit, required this.image, required this.start, required this.end, required this.paid});

  @override
  State<BuzDetailsBanner> createState() => _BuzDetailsBannerState();
}

class _BuzDetailsBannerState extends State<BuzDetailsBanner> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<BusinessProvider>(context,listen: false).getAllBizDetail(widget.biz);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Text(widget.biz,maxLines: 1,overflow:TextOverflow.ellipsis,style: TextStyle(color: Colors.white)),
      ),
      body:Padding(
