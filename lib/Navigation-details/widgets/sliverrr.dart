...
import '../../api/url.dart';
import '../../providers/random.dart';

class RandomPros extends StatefulWidget {
  const RandomPros({super.key});

  @override
  State<RandomPros> createState() => _RandomProsState();
}

class _RandomProsState extends State<RandomPros> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<RandomProvider>(context,listen: false).getRandHousi();
    });
  }
                    ...
                    child: Container(
                      ...
                      child:Stack(
                        children: [
                          ...
                          //       child: Text("${sprice} % OFF",style: const TextStyle(color: Colors.green,fontWeight: FontWeight.bold),),
                          //     ),
                          //   ),
                          // ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(pros[index].plac,maxLines: 1,overflow:TextOverflow.fade,),
                                        ],
                                      ),
                                      SizedBox(height: 3,),
