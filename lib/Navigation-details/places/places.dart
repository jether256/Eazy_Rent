...
class PlacesMore extends StatefulWidget {
  const PlacesMore({super.key});

  @override
  State<PlacesMore> createState() => _PlacesMoreState();
}

class _PlacesMoreState extends State<PlacesMore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Text('Popular Areas',maxLines: 1,overflow:TextOverflow.ellipsis,style: TextStyle(color: Colors.white)),
      ),
      body:Padding(
